...
const calculateExercises = (getValues: Array<string>): Result => {
...
try {
  ...
  console.log(error.message) // Tulostetaan kyseisen muuttujan arvo terminaalin näkyviin, jos tulee virheitä.
}
