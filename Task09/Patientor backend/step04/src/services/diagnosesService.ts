...
import { Diagnose } from '../types/appTypes'; // Tuodaan "Diagnose" funktio sovelluksen käytettäväksi, joka sijaitsee "appTypes.ts" tiedostossa.
...
const showDiagnoses: Array<Diagnose> = diagnosesData;
