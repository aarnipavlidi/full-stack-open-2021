...
import patientsRouter from './routes/patientsRouter'; // Alustetaan muuttuja "patientsRouter", joka ottaa käyttöön "patientsRouter.ts" tiedoston sisällön.
...
app.use('/api/patients', patientsRouter); // Jos käyttäjä tekee pyyntöä kyseiseen osoitteeseen, niin sovellus hyödyntää "patientsRouter" muuttujan sisältöä pyynnön aikana.
