...
import { Patient, PatientWithoutId } from '../types/appTypes'; // Tuodaan "Patient" ja "PatientWithoutId" funktiot sovelluksen käytettäväksi, joka sijaitsee "appTypes.ts" tiedostossa.
