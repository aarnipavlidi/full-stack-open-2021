...
// Tehtävää "9.22: patientor, step7" varten lisätty uusi komponentti "Hospital", joka
...
const Hospital = ({ getValues, diagnosisData }: { getValues: Entry, diagnosisData: Diagnosis[] }) => {
  ...
  if (getValues.type === "Hospital") {
    return (
      <Container className="custom-container">
        <div className='entry-css'>
          <p><b>{getValues.date}:</b> {getValues.description} <i className="far fa-hospital"></i></p>
            <ul>
...
// Viedään (export) alla oleva komponentti (Hospital) sovelluksen käytettäväksi, jotta esim. "index.tsx" tiedosto pystyy suorittamaan kyseiset funktiot.
