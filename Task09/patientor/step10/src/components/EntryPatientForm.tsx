  ...
  return (
    <Formik
      ...
      validate={values => {
        ...
        // Lisätty "9.25: patientor, step10" tehtävää varten "NormalString" niminen tyyppi,
        // joka on luotu esim. "specialist" objektin arvolle. Kun käyttäjä yritätä lisätä
        // uuden arvon tietokantaan ja kyseinen objektin arvo puuttuu lomakkeesta, niin
        // "errors" muuttujan avulla ilmestyy => specialist: "Field is required" arvo.
        type NormalString = { [field: string]: string };

        // Lisätty "9.25: patientor, step10" tehtävää varten "DischargeValues" niminen tyyppi,
        // joka on luotu "discharge" objektin arvolle. Kyseinen arvo on "nested object", jonka
        // sisältä löytyy vielä "date" sekä "criteria" objektien arvot. Eli aina kun käyttäjä
        // yrittää lisätä "Hospital" entryn arvon, niin kyseistä tyyppiä hyödynnetään.
        type DischargeValues = { [field: string] : {
          date?: string;
          criteria?: string;
        }};

        // Muokattu alla olevaa muuttujaa "errors" tehtävää "9.25: patientor, step10" varten niin,
        // että lisätty sekä "NormalString" ja "DischargeValues" tyypit. Aina kun kyseiseen muuttujaan
        // tehdään viittaus, niin muuttuja palauttaa takaisin datan, joka noudattaa joko "NormalString"
        // tyypin rakennetta tai "DischargeValues" tyypin rakennetta. Näiden avulla pystytään renderöimään
        // takaisin käyttäjälle "Field is required" teksti puuttuvan kentän alapuolelle!
        const errors: NormalString | DischargeValues = {};
        console.log(errors);
