...
export const useCreateValue = (newValueType) => {
  ...
  // Alustetaan muuttuja "resetInputValue", joka suorittaa {...} sisällä olevat asiat,
  // aina kun kyseiseen funktioon tehdään viittaus eli aina kun käyttäjä haluaa
  // poistaa input:in kentät (kun yrittää luoda uutta arvoa tietokantaan), niin
  // kaikkien muuttujien "state" tyhjennetään alkuperäiseen tilaan.
