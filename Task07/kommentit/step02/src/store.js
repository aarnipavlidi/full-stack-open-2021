...
import userReducer from './reducers/userReducer' // Alustetaan muuttuja "userReducer", joka hyödyntää "userReducer.js" tiedoston sisältöä sovelluksen aikana.
...
// sovellus renderöidään, niin konsoliin (redux-devtools) ilmestyy myös kolme (3)
// objektia eli => "values", "message" ja "user", jotka saavat sisällä olevien
// muuttujien datan käyttöönsä eli => "blogReducer" ja "notificationReducer".
