...
const App = () => { // Sovellus alkaa tästä...
  ...
  // niin renderöidään => "<h1>Welcome to Bloglist, please log in! :)</h1>" sekä suoritetaan "loginForm()" funktio. Jos käyttäjä on jo kirjautunut
  // sisään sovellukseen, niin renderöidään => "<h1>Bloglist</h1>" ja suoritetaan "showBlogs()" funktio.
  return (
    <div>
      {userInfo === null ?
        <div>
