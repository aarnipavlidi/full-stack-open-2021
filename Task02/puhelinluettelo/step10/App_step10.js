...
const App = () => {
  ...
  // Alustetaan muuttuja "handlePersonDelete" ja miten tämän muuttujan funktiota käytetään, niin jokaiselle puhelinluettelossa olevalla nimelle ilmestyy painike "delete" tietojen perään.
