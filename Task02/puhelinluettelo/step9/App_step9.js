...
const App = () => {
  ...
  // Alustetaan muuttuja "handldePersonDelete" ja miten tämän muuttujan funktiota käytetään, niin jokaiselle puhelinluettelossa olevalla nimelle ilmestyy painike "delete" tietojen perään.
