...
// Muista vaihtaa seuraavasta tiedostosta => fullstack-open-2021/Task02/puhelinluettelo/step9/services/notesPersons_step9.js
// rivistä kaksi (2) muuttujan arvo eli "database" => arvoon "http://localhost:3001/api/persons". Tämän jälkeen sekä
// frontend että backend toimivat yhdessä moiteettomasti (paitsi puh. numeroiden muutoksien osalta!).
...
const port = 3001 // Alustetaan muuttuja "port", joka on yhtä kuin "3001". Sovellus ottaa siis käyttöön kyseisen portin numeron!
