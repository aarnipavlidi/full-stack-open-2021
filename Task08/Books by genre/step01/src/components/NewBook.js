...
// Alustetaan "NewBook" komponetti, joka suorittaa {...} sisällä olevat asiat, kun siihen tehtään
// vittaus. Komponentti saa myös käyttöönsä "showNewBook" ja "setNotification" parametrin arvot.
const NewBook = ({ showNewBook, setNotification }) => {
