...
import { BOOK_ADDED } from './queries' // Sovellus ottaa käyttöön kyseiset funktiot "queries.js" tiedostosta.
...
const App = () => { // Sovellus alkaa tästä...
  ...
  useSubscription(BOOK_ADDED, {
    onSubscriptionData: ({ subscriptionData }) => {
      alert(`New book called ${subscriptionData.data.bookAdded.title} by ${subscriptionData.data.bookAdded.author.name} has been added to the list! :)`)
    }
  })
